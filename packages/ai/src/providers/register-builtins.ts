...
interface AnthropicProviderModule {
  ...
  streamSimpleAnthropic: StreamFunction<
    "anthropic-messages",
    SimpleStreamOptions
  >;
}
...
interface AzureOpenAIResponsesProviderModule {
  streamAzureOpenAIResponses: StreamFunction<
    "azure-openai-responses",
    AzureOpenAIResponsesOptions
  >;
  streamSimpleAzureOpenAIResponses: StreamFunction<
    "azure-openai-responses",
    SimpleStreamOptions
  >;
}
...
interface GoogleGeminiCliProviderModule {
  streamGoogleGeminiCli: StreamFunction<
    "google-gemini-cli",
    GoogleGeminiCliOptions
  >;
  streamSimpleGoogleGeminiCli: StreamFunction<
    "google-gemini-cli",
    SimpleStreamOptions
  >;
}
...
interface GoogleVertexProviderModule {
  ...
  streamSimpleGoogleVertex: StreamFunction<
    "google-vertex",
    SimpleStreamOptions
  >;
}
...
interface MistralProviderModule {
  ...
  streamSimpleMistral: StreamFunction<
...
interface OpenAICodexResponsesProviderModule {
  ...
  >;
  streamSimpleOpenAICodexResponses: StreamFunction<
    "openai-codex-responses",
    SimpleStreamOptions
  >;
}
...
interface OpenAICompletionsProviderModule {
  streamOpenAICompletions: StreamFunction<
    "openai-completions",
    OpenAICompletionsOptions
  >;
  streamSimpleOpenAICompletions: StreamFunction<
    "openai-completions",
    SimpleStreamOptions
  >;
}
...
interface OpenAIResponsesProviderModule {
  streamOpenAIResponses: StreamFunction<
    "openai-responses",
    OpenAIResponsesOptions
  >;
  streamSimpleOpenAIResponses: StreamFunction<
    "openai-responses",
    SimpleStreamOptions
  >;
}
...
function loadAzureOpenAIResponsesProviderModule(): Promise<
  ...
  >
> {
  azureOpenAIResponsesProviderModulePromise ||= import(
...
function loadGoogleGeminiCliProviderModule(): Promise<
  ...
  >
> {
  googleGeminiCliProviderModulePromise ||= import(
...
> {
  googleVertexProviderModulePromise ||= import("./google-vertex.js").then(
    (module) => {
...
function loadOpenAICodexResponsesProviderModule(): Promise<
  ...
  >
> {
  openAICodexResponsesProviderModulePromise ||= import(
...
function loadOpenAICompletionsProviderModule(): Promise<
  ...
  >
> {
  openAICompletionsProviderModulePromise ||= import(
...
function loadOpenAIResponsesProviderModule(): Promise<
  ...
  >
> {
  openAIResponsesProviderModulePromise ||= import("./openai-responses.js").then(
    (module) => {
...
> {
  ...
  bedrockProviderModulePromise ||= importNodeOnlyProvider(
    "./amazon-bedrock.js",
  ).then((module) => {
...
export const streamSimpleGoogleGeminiCli = createLazySimpleStream(
  loadGoogleGeminiCliProviderModule,
);
export const streamGoogleVertex = createLazyStream(
...
const streamSimpleBedrockLazy = createLazySimpleStream(
