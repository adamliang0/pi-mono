...
export interface ExtensionUIContext {
   ...
   * extend `CustomEditor` from `adamliang0/pi-coding-agent` and call
   * `super.handleInput(data)` for keys you don't handle.
   *
   * @example
   * ```ts
   * import { CustomEditor } from "@adamliang0/pi-coding-agent";
   *
...
export type SessionDirectoryHandler = (
  ...
  | Promise<SessionDirectoryResult | undefined>
...
export type ExtensionHandler<E, R = undefined> = (
  event: E,
  ctx: ExtensionContext,
  // biome-ignore lint/suspicious/noConfusingVoidType: ExtensionHandler is used in the generated code
