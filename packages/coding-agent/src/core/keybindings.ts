...
declare module "@adamliang0/pi-tui" {
...
function isLegacyKeybindingName(
  key: string,
): key is keyof typeof KEYBINDING_NAME_MIGRATIONS {
...
function orderKeybindingsConfig(
  config: Record<string, unknown>,
...
export function migrateKeybindingsConfigFile(
