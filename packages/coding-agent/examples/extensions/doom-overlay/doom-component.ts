...
import type { Component } from "@adamliang0/pi-tui";
import { isKeyRelease, type TUI } from "@adamliang0/pi-tui";
...
export class DoomOverlayComponent implements Component {
  ...
  render(width: number): string[] {
    ...
    const truncatedFooter =
      footer.length > width ? footer.slice(0, width) : footer;
