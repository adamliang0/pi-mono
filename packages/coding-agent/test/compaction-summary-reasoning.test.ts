import type { AgentMessage } from "@adamliang0/pi-agent-core";
import type { AssistantMessage, Model } from "@adamliang0/pi-ai";
...
vi.mock("@adamliang0/pi-ai", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@adamliang0/pi-ai")>();
  return {
    ...actual,
