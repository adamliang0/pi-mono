 ...
 *
 * Internal dependency semver sync is `scripts/sync-versions.js` (runs after this from `version:*`);
 * it overwrites `^x.y.z` for in-repo packages but does not replace `workspace:*` / `workspace:` ranges.
 */
